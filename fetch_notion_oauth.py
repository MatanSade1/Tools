#!/usr/bin/env python3
"""
Fetch all calendar entries from Notion using OAuth token.
...
def load_access_token():
    ...
    try:
        ...
        print()
        print("Please run notion_oauth_flow.py first to authorize")
        return None


def query_notion_database(access_token: str, start_date: str, end_date: str):
...
def main():
    print("=" * 80)
    print("Notion to BigQuery - OAuth Method (Deterministic)")
    print("=" * 80)
    ...
    pages = query_notion_database(access_token, START_DATE, END_DATE)
